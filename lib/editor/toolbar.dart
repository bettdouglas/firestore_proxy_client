...
//               log.log("Building toolbar. Selection: $selection");
//               if (selection == null) {
...
//                 splashRadius: 16,
//                 tooltip: "More Options(not implemented)",
//               ),
//             ),
//           ],
//         ),
...
//         valueListenable: widget.composer.selectionNotifier,
//         builder: (context, selection, child) {
//           log.log("Building image toolbar. Selection: $selection");
//           if (selection == null) {
//             return const SizedBox();
//           }
...
//         log.log("(Re)Building _PositionedToolbar widget due to anchor change");
//         if (offset == null || composer.selection == null) {
//           log.log("Anchor is null. Building an empty box.");
//           // When no anchor position is available, or the user hasn't
//           // selected any text, show nothing.
//           return const SizedBox();
//         }

//         log.log("Anchor is non-null: $offset, child: $child");
